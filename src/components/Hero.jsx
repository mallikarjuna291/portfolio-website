        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <div className="inline-block bg-gray-900 text-green-400 px-4 md:px-6 py-2 rounded-lg font-mono text-xs md:text-sm mb-6 md:mb-8 shadow-lg border border-gray-700">
              ...
              <div className="text-gray-300 mt-1 text-xs md:text-sm">Loading Lanka Mallikarjuna...</div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 max-w-4xl mx-auto px-4">
              <div className="bg-white dark:bg-gray-800 rounded-lg md:rounded-xl p-4 md:p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                <div className="text-2xl md:text-3xl font-bold text-green-600 mb-1 md:mb-2">60%</div>
                <div className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Onboarding Boost</div>
                <div className="text-xs text-gray-500 mt-1 hidden md:block">Partner Portal Impact</div>
              </div>

              <div className="bg-white dark:bg-gray-800 rounded-lg md:rounded-xl p-4 md:p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                <div className="text-2xl md:text-3xl font-bold text-blue-600 mb-1 md:mb-2">58%</div>
                <div className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Build Time Cut</div>
                <div className="text-xs text-gray-500 mt-1 hidden md:block">Webpack → Vite Migration</div>
              </div>
