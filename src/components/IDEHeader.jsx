    ...
    <div className="bg-gray-200 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700">
      ...
      <div className="hidden md:block bg-gray-100 dark:bg-gray-900 px-4 py-1 border-b border-gray-300 dark:border-gray-700">
        <div className="flex items-center justify-between text-xs text-gray-600 dark:text-gray-400">
          ...
          <div className="flex items-center gap-4">
            <span className="text-gray-800 dark:text-gray-200">Lanka's Portfolio IDE</span>
            ...
            <Tooltip content={darkMode ? "Switch to Light Mode" : "Switch to Dark Mode"} position="bottom">
              ...
              >
                ...
                <div className={`w-9 h-5 flex items-center rounded-full p-0.5 transition-all duration-300 ${
                  ...
                  {/* Toggle Slider */}
                  <div className={`w-4 h-4 rounded-full shadow-md transform transition-all duration-300 flex items-center justify-center ${
                    darkMode
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="p-2 bg-gray-50 dark:bg-gray-700 rounded">
                ...
                <span className="text-gray-600 dark:text-gray-300 ml-2">- Contact Lanka</span>
              </div>
              <div className="p-2 bg-gray-50 dark:bg-gray-700 rounded">
