        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              onBlur={handleBlur}
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 dark:bg-gray-800 dark:text-white transition-all duration-150 ${
      ...
      <div>
        ...
        <div className="relative">
          <textarea
            ...
            onChange={handleChange}
            onBlur={handleBlur}
            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 dark:bg-gray-800 dark:text-white transition-all duration-150 resize-none ${
