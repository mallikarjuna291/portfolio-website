  ...
  const contactInfo = [
    {
      ...
      label: 'Email',
      value: 'lankamallikarjuna108@gmail.com',
      link: 'mailto:lankamallikarjuna108@gmail.com'
    },
    {
      icon: (
      ...
      label: 'LinkedIn',
      value: 'linkedin.com/in/lankamallikarjuna',
      link: 'https://linkedin.com/in/lankamallikarjuna'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      label: 'GitHub',
      value: 'github.com/mallikarjuna291',
      link: 'https://github.com/mallikarjuna291'
    }
  ]
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
              ...
              discuss new opportunities and collaborate on innovative ideas. 
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {contactInfo.map((info, index) => (
                    <a
                      ...
                      className="flex items-center gap-4 p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150 group"
                    >
              ...
              <div className="card p-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-600 dark:text-gray-300 text-sm">Available for new projects</span>
                </div>
              </div>
            </div>
          </div>
